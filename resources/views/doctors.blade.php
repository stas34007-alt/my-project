...
<head>
    ...
    <link rel="stylesheet" href="{{asset('styles/doctor.css')}}">
        ...
        <div class="cont-doctor-card">
            ...
            <div class="doctor-card">
                <div class="card-header">
                    <img src="{{ asset('images/' . $doctor->avatar) }}" 
                        alt="{{ $doctor->user->full_name }}" 
                        class="doctor-photo">
                    
                    <div class="doctor-info">
                        <h2 class="doctor-name">{{ $doctor->user->full_name }}</h2>
                ...
                <div class="card-footer">
                    <div class="price">
                        {{$doctor->online_consultation_price}}
                        <span class="price-label">первичный приём</span>
                    </div>
                    <a href="{{route('show_doctor', $doctor->id)}}"><button class="btn-book">Записаться</button></a>
                </div>
            </div>
            @endforeach
        </div>
