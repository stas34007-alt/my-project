...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('styles/reg.css')); ?>">
    ...
    <div class="login-container">
        ...
        <div class="login-form-section">
            <div class="login-form-wrapper">
                ...
                <!-- Форма регистрации -->
                <form class="login-form" action="<?php echo e(route('registr')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <!-- Поле ФИО -->
                ...
                <p class="register-link">
                    Уже есть аккаунт?
                    <a href="<?php echo e(route('autorisation')); ?>">Войти</a>
                </p>
...
</html><?php /**PATH C:\OSPanel\domains\diplom-2026\resources\views/register.blade.php ENDPATH**/ ?>